...
from statistics_manager_service.test.helper_functions import (
    clean_influxdb,
    populate_influxdb_power_exported,
    clean_account,
    superuser_login,
    mock_register,
...
class TestPowerQueriesControllerInjectionHistoric(BaseTestCase):
    """PowerQueriesController for injection historic values integration test stubs"""

    def test_power_injection_get_daily(self):
        """Test case for power_injection_get using group_by daily

        Retrieve the power injection for a user grouped by daily
        """
        clean_account()
    ...
    def test_power_injection_get_hourly(self):
        """Test case for power_injection_get using group_by hourly

        Retrieve the power injection for a user grouped by hourly
        """
        clean_account()
    ...
    def test_power_injection_get_15min(self):
        """Test case for power_injection_get using group_by 15min

        Retrieve the power injection for a user grouped by 15min
        """
        clean_account()
    ...
    def test_power_injection_get_monthly(self):
        """Test case for power_injection_get using group_by monthly

        Retrieve the power injection for a user grouped by monthly
        """
        clean_account()
    ...
    def test_power_injection_get_weekly(self):
        """Test case for power_injection_get using group_by weekly

        Retrieve the power injection for a user grouped by weekly
        """
        clean_account()
    ...
    def test_power_injection_get_several_users_and_no_api_key(self):
        """Test case for power_injection_get using group_by weekly for several users

        Retrieve the power injection for several users grouped by weekly
    ...
    def test_power_injection_get_empty(self):
        """Test case for power_injection_get using group_by weekly for one user with no data on DB.

        Retrieve the power injection for one user grouped by weekly, but with no data on DB.
        """
        clean_account()
    ...
    def test_power_injection_get_wrong_userid(self):
        """Test case for power_injection_get using group_by weekly but with a non existing user_id

        Retrieve the power injection for a user grouped by weekly but with a non existing user_id
        """
        clean_account()
    ...
    def test_power_injection_get_several_users_with_authentication(self):
        """Test case for power_injection_get using group_by weekly for several users with authentication
        Meaning that the user will not have access to the other user_id

        Retrieve the power injection for several users grouped by weekly with authentication
    ...
    def test_power_injection_get_weekly_without_end_date(self):
        """Test case for power_injection_get using group_by weekly without end_date parameter

        Retrieve the power injection for a user grouped by weekly without end_date parameter
        """
        clean_account()
