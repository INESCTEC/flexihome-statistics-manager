...
class TestPowerQueriesControllerInjectionLast(BaseTestCase):
    """PowerQueriesController for injection last values integration test stubs"""

    def test_power_injection_last_get(self):
        """Test case for power_injection_last_get

        Retrieve the last value of the power injection for one user.
        """
        clean_account()
    ...
    def test_power_injection_last_get_several_users_and_no_api_key(self):
        """Test case for power_injection_last_get for several users

        Retrieve the last value of the power injection for several users.
    ...
    def test_power_injection_last_get_empty(self):
        """Test case for power_injection_last_get with an empty value on DB

        Retrieve the last value of the power injection for several users but there is no value on DB.
        """
        clean_account()
    ...
    def test_power_injection_wrong_userid(self):
        """Test case for power_injection_last_get with a non existing user_id

        Retrieve the last value of the power injection for several users with a non existing user_id
        """
        clean_account()
    ...
    def test_power_injection_last_get_several_users_with_authentication(self):
        """Test case for power_injection_last_get for several users with authentication
        Meaning that the user will not have access to the other user_id

        Retrieve the last value of the power injection for several users with authentication
