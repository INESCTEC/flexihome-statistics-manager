...
from statistics_manager_service.models.instant_voltage_metric import InstantVoltageMetric  # noqa: E501
from statistics_manager_service.models.voltage_metrics import VoltageMetrics  # noqa: E501
from statistics_manager_service.test import BaseTestCase

from statistics_manager_service.test.helper_functions import (
    clean_influxdb,
    populate_influxdb_voltage,
    clean_account,
    superuser_login,
    mock_register,
...
class TestVoltageQueriesControllerHistoric(BaseTestCase):
    """VoltageQueriesController for historic values integration test stubs"""

    def test_voltage_get_daily(self):
        """Test case for voltage_get using group_by daily

        Retrieve the voltage for a user grouped by daily
        """
        clean_account()
        ...
        self.assertEqual(metrics_dict["1"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["2"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["3"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["4"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["5"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["6"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["7"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["8"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["9"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["10"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["11"]["units"], "V")
        self.assertTrue(math.isnan(metrics_dict["11"]["value"]))

    def test_voltage_get_hourly(self):
        """Test case for voltage_get using group_by hourly

        Retrieve the voltage for a user grouped by hourly
        """
        clean_account()
        ...
        self.assertEqual(metrics_dict["12"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["13"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["14"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["15"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["16"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["17"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["18"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["19"]["units"], "V")
        self.assertAlmostEqual(metrics_dict["19"]["value"], round((2632.2 + 1401.2) / 2, 2), delta=0.01)

    def test_voltage_get_15min(self):
        """Test case for voltage_get using group_by 15min

        Retrieve the voltage for a user grouped by 15min
        """
        clean_account()
    ...
    def test_voltage_get_monthly(self):
        """Test case for voltage_get using group_by monthly

        Retrieve the voltage for a user grouped by monthly
        """
        clean_account()
    ...
    def test_voltage_get_weekly(self):
        """Test case for voltage_get using group_by weekly

        Retrieve the voltage for a user grouped by weekly
        """
        clean_account()
        ...
        self.assertEqual(metrics_dict["20"]["units"], "V")
        ...
        self.assertEqual(metrics_dict["21"]["units"], "V")
        self.assertTrue(math.isnan(metrics_dict["21"]["value"]))

    def test_voltage_get_several_users_and_no_api_key(self):
        """Test case for voltage_get using group_by weekly for several users

        Retrieve the voltage for several users grouped by weekly
    ...
    def test_voltage_get_empty(self):
        """Test case for voltage_get using group_by weekly for one user with no data on DB.

        Retrieve the voltage for one user grouped by weekly, but with no data on DB.
        """
        clean_account()
    ...
    def test_voltage_get_wrong_userid(self):
        """Test case for voltage_get using group_by weekly but with a non existing user_id

        Retrieve the voltage for a user grouped by weekly but with a non existing user_id
        """
        clean_account()
    ...
    def test_voltage_get_several_users_with_authentication(self):
        """Test case for voltage_get using group_by weekly for several users with authentication
        Meaning that the user will not have access to the other user_id

        Retrieve the voltage for several users grouped by weekly with authentication
    ...
    def test_voltage_get_weekly_without_end_date(self):
        """Test case for voltage_get using group_by weekly without end_date parameter

        Retrieve the voltage for a user grouped by weekly without end_date parameter
        """
        clean_account()
