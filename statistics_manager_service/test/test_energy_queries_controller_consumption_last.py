...
class TestEnergyQueriesControllerConsumptionLast(BaseTestCase):
    """EnergyQueriesController for consumption last values integration test stubs"""

    def test_energy_consumption_last_get(self):
        """Test case for energy_consumption_last_get

        Retrieve the last value of the energy consumption for one user.
        """
        clean_account()
        ...
        response = self.client.open(
            "/api/statistics/energy-consumption-last",
            method="GET",
            headers=headers,
    ...
    def test_energy_consumption_last_get_several_users_and_no_api_key(self):
        """Test case for energy_consumption_last_get for several users
    ...
    def test_energy_consumption_last_get_empty(self):
        """Test case for energy_consumption_last_get with an empty value on DB

        Retrieve the last value of the energy consumption for several users but there is no value on DB.
        """
        clean_account()
    ...
    def test_energy_consumption_wrong_userid(self):
        """Test case for energy_consumption_last_get with a non existing user_id

        Retrieve the last value of the energy consumption for several users with a non existing user_id
        """
        clean_account()
    ...
    def test_energy_consumption_last_get_several_users_with_authentication(self):
        """Test case for energy_consumption_last_get for several users with authentication
        Meaning that the user will not have access to the other user_id

        Retrieve the last value of the energy consumption for several users with authentication
